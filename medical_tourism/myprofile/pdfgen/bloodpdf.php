...
$q = " SELECT * FROM `bloodcampappointment` WHERE slno = $id ";
      ...
      <table class="meta" id="top_data_table">
         <tbody>
          <tr class="" id="invoice_number_row">
            ...
            <td><?php echo "BloodCampApp-".$row['slno'];?></td>
          </tr>
	...
	<div class="min_height">
      <table class="inventory">
        <thead>
          <tr>
            <th class="bold">
              <span class="item" id="item">Booking Type</span>
            </th>
            <th class="bold">
              <span class="description" id="description">Age & Gender</span>
            </th>
            <th class="bold">
              <span class="rate" id="rate">Blood Grp</span>
            </th>
            <th class="bold">
              <span class="quantity" id="quantity">Disease</span>
            </th>
          </tr>
        </thead>
        ...
        <tbody>
          <tr>
            <td>
              ...
              <span contenteditable><?php echo $row['booking_type'];?></span>
            </td>
            <td >
              <span contenteditable><?php echo $row['age']." , ".$row['gender'];?></span>
              </td>
            <td>
              <span data-prefix><?php echo $row['blood_grp'];?></span>
              
            </td>
            <td>
              <span contenteditable><?php echo $row['chronic_disease'];?></span>
            </td>
