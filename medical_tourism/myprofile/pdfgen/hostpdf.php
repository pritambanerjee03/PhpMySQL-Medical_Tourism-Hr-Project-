...
$q = " SELECT * FROM `hostappointment` WHERE slno = $id ";
  ...
  <form>
    ...
    <article class="invoicebody">
	    <div class="left_info">
	      ...
	      <input type="text" class="clientDetails" id="customer_name" placeholder="Patient Address" value="<?php echo $row['organization'];?>"><br>
	      <input type="text" class="clientDetails" id="occupation"    placeholder="Patient Address" value="<?php echo $row['eventname']?>"><br>
      ...
      <table class="meta" id="top_data_table">
         <tbody>
          <tr class="" id="invoice_number_row">
            ...
            <td id="time" hidden></td>
            <td><?php echo "HostApp-".$row['slno'];?></td>
          </tr>
	...
	<div class="min_height">
      <table class="inventory">
        <thead>
          <tr>
            <th class="bold">
              <span class="item" id="item">Performer Name</span>
            </th>
            <th class="bold">
              <span class="description" id="description">Genre</span>
            </th>
            <th class="bold">
              <span class="rate" id="rate">Start Date</span>
            </th>
            <th class="bold">
              <span class="quantity" id="quantity">Venue</span>
            </th>
          </tr>
        </thead>
        ...
        <tbody>
          <tr>
            <td>
              ...
              <span contenteditable><?php echo $row['performer_name'];?></span>
            </td>
            <td >
              <span contenteditable><?php echo $row['genre'];?></span>
              </td>
            <td>
              <span data-prefix><?php echo $row['startdate'];?></span>
              
            </td>
            <td>
              <span contenteditable><?php echo $row['venue'];?></span>
            </td>
