...
$q = " SELECT * FROM `seminarappointment` WHERE slno = $id ";
      ...
      <table class="meta" id="top_data_table">
         <tbody>
          <tr class="" id="invoice_number_row">
            ...
            <td><?php echo "SeminarApp-".$row['slno'];?></td>
          </tr>
      ...
      <table class="inventory">
        <thead>
          <tr>
            ...
            <th class="bold">
              <span class="description" id="description">Date & Time</span>
            </th>
            <th class="bold">
              <span class="rate" id="rate">No of Seats</span>
            </th>
            <th class="bold">
              <span class="quantity" id="quantity">Seat Type</span>
            </th>
          </tr>
        </thead>
        ...
        <tbody>
          <tr>
            ...
            <td >
              <span contenteditable><?php echo $row['date']." <br> ".$row['time'];?></span>
              </td>
            <td>
              <span data-prefix><?php echo $row['no_of_seats'];?></span>
              
            </td>
            <td>
              <span contenteditable><?php echo $row['seat_type'];?></span>
            </td>
