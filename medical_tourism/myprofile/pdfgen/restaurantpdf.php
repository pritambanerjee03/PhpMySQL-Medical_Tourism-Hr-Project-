...
$q = " SELECT * FROM `restaurantappointment` INNER JOIN doctorappointment ON restaurantappointment.docslno=doctorappointment.slno WHERE restaurantappointment.slno = $id ";
      ...
      <table class="meta" id="top_data_table">
         <tbody>
          <tr class="" id="invoice_number_row">
            ...
            <td><?php echo "RestaurantApp-".$id;?></td>
          </tr>
	...
	<div class="min_height">
      <table class="inventory">
        <thead>
          <tr>
            <th class="bold">
              <span class="item" id="item">Restaurant Name</span>
            </th>
            <th class="bold">
              <span class="description" id="description">Date</span>
            </th>
            <th class="bold">
              <span class="rate" id="rate">Time</span>
            </th>
            <th class="bold">
              <span class="quantity" id="quantity">Food Pref. & Persons</span>
            </th>
            <th class="bold">
        ...
        <tbody>
          <tr>
            <td>
              ...
              <span contenteditable><?php echo $row['restaurant_name'];?></span>
            </td>
            <td >
              <span contenteditable><?php echo $row['date'];?></span>
              </td>
            <td>
              <span data-prefix><?php echo $row['time'];?></span>
              
            </td>
            <td>
              <span contenteditable><?php echo $row['food_pref']." , ".$row['persons'];?></span>
            </td>
