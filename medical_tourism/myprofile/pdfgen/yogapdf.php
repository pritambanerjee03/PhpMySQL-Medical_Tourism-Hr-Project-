...
$q = " SELECT * FROM `yogacampappointment` WHERE slno = $id ";
  ...
  <form>
    ...
    <article class="invoicebody">
	    <div class="left_info">
	      ...
	      <input type="text" class="clientDetails" id="occupation"    placeholder="Patient Address" value="<?php echo $row['personal_Id']." , ".$row['personal_Id_no'];?>"><br>
      ...
      <table class="meta" id="top_data_table">
         <tbody>
          <tr class="" id="invoice_number_row">
            ...
            <td><?php echo "YogaApp-".$row['slno'];?></td>
          </tr>
	...
	<div class="min_height">
      <table class="inventory">
        <thead>
          <tr>
            <th class="bold">
              <span class="item" id="item">Program Name</span>
            </th>
            <th class="bold">
              <span class="description" id="description">Location & Duration</span>
            </th>
            <th class="bold">
              <span class="rate" id="rate">Start Date</span>
            </th>
            <th class="bold">
              <span class="quantity" id="quantity">Food Choice</span>
            </th>
          </tr>
        </thead>
        ...
        <tbody>
          <tr>
            <td>
              ...
              <span contenteditable><?php echo $row['booking_type']." on <br>".$row['program_name'];?></span>
            </td>
            <td >
              <span contenteditable><?php echo $row['location']." , ".$row['duration'];?></span>
              </td>
            <td>
              <span data-prefix><?php echo $row['start_date'];?></span>
              
            </td>
            <td>
              <span contenteditable><?php echo $row['food_choice'];?></span>
            </td>
