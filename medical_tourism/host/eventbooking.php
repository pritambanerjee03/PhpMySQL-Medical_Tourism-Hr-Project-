...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50">
  ...
  <div class="container-fluid">
    ...
    <div id="myCarousel" class="carousel slide padbottom1" data-ride="carousel">
      ...
      <div class="item active">
        ...
        <div class="carousel-caption">
          ...
          <p>The atmosphere in Kolkata is Awesome.</p> 
                ...
                <br><br> -->
                <div class="button">
                    <a href="" class="btn btn-first" data-toggle="modal" data-target="#myModal1">Info</a>
                    <a  onclick="formblock(0)" ondblclick="formblock(1)"  class="btn btn-second" title="Single click to open the form or Double click to close">Book Now</a>
                </div>
                  ...
                  <div class="row">
                      <div class="col-md-12">
                            <div class="thumbnail text-center">
                               <img src="images/event_medical/seminar.jpg" class="img-circle person" alt="kolkata" width="200" height="200">
      ...
      <div class="item">
        ...
        <div class="carousel-caption">
          ...
          <p>Thank you, Mumbai - A night we won't forget.</p>
                ...
                <br><br> -->
                <div class="button">
                    <a href="" class="btn btn-first" data-toggle="modal" data-target="#myModal2">Info</a>
                    <a  onclick="formblock(0)" ondblclick="formblock(1)"  class="btn btn-second" title="Single click to open the form or Double click to close">Book Now</a>
        ...
        <div class="carousel-caption">
          ...
          <p>Even though the traffic was a mess, we had the best time playing at Bangalore!</p>
              <P>
                ...
                <br><br> -->
                <div class="button">
                    <a href="" class="btn btn-first" data-toggle="modal" data-target="#myModal3">Info</a>
                    <a  onclick="formblock(0)" ondblclick="formblock(1)"  class="btn btn-second" title="Single click to open the form or Double click to close">Book Now</a>
                   ...
                   <div class="row">
                      ...
                      <div id="sectionSeminar">  
                        ...
                        <div class="col-sm-10">
                          ...
                          <select class="form-control" id="inputProgramName" name="inputProgramName"  >
                         ...
                         <div class="row">
                          ...
                          <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                              ...
                              <select class="form-control" id="inputSeminarDate" name="inputSeminarDate"  >
                        ...
                        <div class="col-sm-6">
                          ...
                          <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                              ...
                              <select class="form-control" id="inputSeminarTime" name="inputSeminarTime"  >
                        ...
                        <div class="row">
                          ...
                          <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                              ...
                              <select class="form-control" id="inputSeminarSeatNo" name="inputSeminarSeatNo"  >
                        ...
                        <div class="col-sm-6">
                          ...
                          <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                              ...
                              <select class="form-control" id="inputSeminarSeatType" name="inputSeminarSeatType"  >
...
<option   value="70">70</option>
                        ...
                        <div class="row">
                          ...
                          <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                              ...
                              <select class="form-control" id="inputBloodDonationCampBloodGroup" name="inputBloodDonationCampBloodGroup"  >
                        ...
                        <div class="col-sm-10">
                          ...
                          <textarea type="text" class="form-control" id="inputRegarding" name="inputBloodDonationCampDiseaseDetails"   placeholder="Write those Disease details here."   ></textarea>
