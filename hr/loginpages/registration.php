		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<div class="box-register">
					<form name="registration" id="registration"  method="post" action="../phpfiles/adduser.php">
						<fieldset>
							<legend>
								Sign Up
							</legend>
							...
							<div class="form-group">
								<span class="input-icon">
									<input type="password" class="form-control" name="cpassword" placeholder="Password Again" required>
									<i class="fa fa-lock"></i> </span>
							</div>
							<div class="form-group">
