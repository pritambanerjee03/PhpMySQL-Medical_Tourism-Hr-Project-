<?php
    session_start();
        ...
        if(!isset($_SESSION['Iv_Name']))
		{
			header('location: admin/index.php');
		}

    include('dbconfig/config.php');
    $Iv_Name=$_SESSION['Iv_Name'];
?>
<?php
    ...
    include('dbconfig/config.php');
        ...
        {
            $sql=mysqli_query($con,"SELECT Iv_Password FROM interviewerinfo where Iv_Password='".$_POST['cpass']."' && Iv_Email='".$_SESSION['Iv_Email']."'");
            $num=mysqli_fetch_array($sql);
            if($num>0)
            {
             $con=mysqli_query($con,"update interviewerinfo set Iv_Password='".$_POST['npass']."' where Iv_Email='".$_SESSION['Iv_Email']."'");
                header("location: indexinterviewer.php");
        ...
        {
             $con=mysqli_query($con,"update interviewerinfo set Iv_Name='".$_POST['fname']."', Iv_Mobile='".$_POST['contact']."',Iv_Address='".$_POST['address']."' where Iv_Email='".$_SESSION['Iv_Email']."'");
        ...
        if(isset($_SESSION['Iv_Email']))
        {
        $sql=mysqli_query($con,"SELECT * FROM `interviewerinfo` WHERE Iv_Email='".$_SESSION['Iv_Email']."'");
           ...
           ?>
               <script>
                   window.onload=function(){
                       document.getElementById("fname").value="<?php echo $row['Iv_Name']; ?>";
                       document.getElementById("contact").value="<?php echo $row['Iv_Mobile']; ?>";
                       document.getElementById("address").value="<?php echo $row['Iv_Address']; ?>";
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Welcome <?php echo $Iv_Name; ?></a>
 ...
 <!--<div class="jumbotron" id="ab1"></div>-->
  ...
  <div class="col-md-4">
    <div class="list-group" id="list-tab" role="tablist">
      <a class="list-group-item list-group-item-action active" id="list-messages-list" data-toggle="list" href="#list-messages" role="tab" aria-controls="messages">View Applicants</a>
      <a class="list-group-item list-group-item-action" id="list-settings-list" data-toggle="list" href="#list-settings" role="tab" aria-controls="settings">Manage Applicants</a>
            ...
            <div class="card-body  table-responsive-sm">
                 <center><h4>View Applicants</h4></center><br>
                            <?php
                                 ...
                                 $Iv_Id=$_SESSION['Iv_Id'];
                                $Iv_Name=$_SESSION['Iv_Name'];
                                $Status="Scheduled";
                
                                $sql="SELECT * FROM appliedjobs INNER JOIN userinfo  ON appliedjobs.Applicant_id = userinfo.Applicant_id  INNER JOIN addjobs  ON appliedjobs.Job_id  = addjobs.Id INNER JOIN hrinfo  ON appliedjobs.Hr_id  = hrinfo.Hr_Id where appliedjobs.Interviewer_id='$Iv_Id' AND appliedjobs.Status='$Status' ORDER BY appliedjobs.Job_id";
                            ...
                            ?>
                                         <table  class="table table-hover table-bordered">
                                          ...
                                          <?php
                                            ...
                                            {
                                              $modalId=$row ['Aj_Id']."view_applicants";  
                                            ...
                                            <tr>
                                                ...
                                                <?php
                                                             ...
                                                             {
                                                            ?>
                                                <td> <button class="btn-primary btn" data-toggle="modal" data-target="#<?php echo $modalId; ?>"> Edit </button> </td>
                                                 <!-- The Modal -->
                                                      ...
                                                      <div class="modal-content">
                                                        ...
                                                        <!-- Modal body -->
                                                         <div class="modal-body">
                                                          <form method="post" action="applyjobphpfiles/canupdateIV.php">
                                                          ...
                                                          <div class="row">
                                                                <div class="col-md-12">
                                                                   <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="pwd" value="<?php echo $Iv_Name; ?>" readonly>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <div class="row form-group">
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <input type="text" id="datetime" class="form-control" name="Date_Time" value="<?php echo $row ['Date_Time']; ?>">
                                                                            
                                                                            
                                                                            <input type="hidden" id="datetime" class="form-control" name="Aj_Id" value="<?php echo $row ['Aj_Id']; ?>">
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <label for="date-start">Marks Obtained:</label>
                                                                            <input type="text" id="marks" class="form-control" name="Marks" value="<?php echo $row ['Marks']; ?>">
                                                                        </div>
                                                                    </div>
