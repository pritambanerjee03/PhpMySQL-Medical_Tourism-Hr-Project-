 ...
 <!--<div class="jumbotron" id="ab1"></div>-->
  ...
  <div class="col-md-6 text-center">
    <div class="list-group" id="list-tab" role="tablist">
     <a class="list-group-item list-group-item-action active" id="list-user-list" data-toggle="list" href="#list-user" role="tab" aria-controls="user">My Profile</a>
      <a class="list-group-item list-group-item-action" id="list-home-list" data-toggle="list" href="#list-home" role="tab" aria-controls="home">Doctor Appointment</a>
    ...
    <!--<div class="list-group" id="list-tab" role="tablist">
     <a class="list-group-item list-group-item-action" id="list-seminar-list" data-toggle="list" href="#list-seminar" role="tab" aria-controls="seminar">Seminar Booking</a>
      <a class="list-group-item list-group-item-action" id="list-yoga-list" data-toggle="list" href="#list-yoga" role="tab" aria-controls="yoga">YogaCamp Booking</a>
       <a class="list-group-item list-group-item-action" id="list-blood-list" data-toggle="list" href="#list-blood" role="tab" aria-controls="blood">BloodDonation Camp</a>
    </div><br>-->
      </div>
       </div><br>
<div class="row">
          ...
          <div class="card" id="card">
            <div class="card-body  table-responsive-sm">
                 <center><h4>Doctor Appointment</h4></center><br>
                            <?php
                                $sql="SELECT  `name`, `age`, `gender`, `address`, `date_app`, `speciality`, `docname`, `hospital_name`, `mobile`, `email` FROM `doctorappointment` WHERE id = '".$_SESSION['id']."'";
                                        ...
                                        <table  class="table table-hover table-bordered">
                                          ...
                                          <?php
                                            ...
                                            <tr>
                                                ...
                                                <td><a href = 'updateform.php'> <input type = 'button'  class="btn btn-primary btn-sm"  value = 'MODIFY'> </a> </td>
                                                <td><a href = 'deleteform.php'> <input type = 'button'  class="btn btn-primary btn-sm" value = 'CANCEL'> </a> </td>
                                            </tr>
                                            <?php
                                            }
          ...
          <div class="card" id="card">
            <div class="card-body  table-responsive-sm">
                 <center><h4>Host Appointment</h4></center><br>
                            <?php
                                $sql="SELECT `name`, `mobile`, `email`, `organization`, `eventname`, `audience`, `performer_name`,`duration`, `startdate`, `venue` FROM `hostappointment` WHERE  id = '".$_SESSION['id']."'";
                                $res = mysqli_query($con,$sql);
                                    if (mysqli_num_rows($res)>0)
                                       {
                            ?>
          ...
          <div class="card" id="card">
            <div class="card-body  table-responsive-sm">
                 <center><h4>Restaurant Booking</h4></center><br>
                            <?php
                                $sql="SELECT  `patient_name`, `doc_app`, `restaurant_name`, `food_pref`, `persons`, `date`, `time` FROM `restaurantappointment` WHERE id = '".$_SESSION['id']."'";
                                $res = mysqli_query($con,$sql);
                                    if (mysqli_num_rows($res)>0)
                                       {
                            ?>
        ...
        <div class="container-fluid">
          <div class="card" id="card">
            <div class="card-body  table-responsive-sm">
                 <center><h4>Restaurant Booking</h4></center><br>
                            <?php
                                $sql="SELECT  `patient_name`, `doc_app`, `hotel_name`, `check_in`, `check_out`, `rooms`, `guests` FROM `hotelappointment` WHERE id = '".$_SESSION['id']."'";
                                $res = mysqli_query($con,$sql);
                                    if (mysqli_num_rows($res)>0)
                                       {
                            ?>
       ...
       <div class="tab-pane fade" id="list-attend" role="tabpanel" aria-labelledby="list-attend-list">
          ...
          <div class="card" id="card">
            <div class="card-body  table-responsive-sm">
                 <center><h4>Doctor Appointment</h4></center><br>
                           <?php
                                $sql="SELECT  `name`, `email`, `message` FROM `feedback` WHERE username = '".$_SESSION['id']."'";
                                $res = mysqli_query($con,$sql);
                                    if (mysqli_num_rows($res)>0)
                                       {
                            ?>
          ...
          <div class="card" id="card">
            <div class="card-body  table-responsive-sm">
                 <center><h4>Seminar Booking</h4></center><br>
                            <?php
                                $sql="SELECT `name`, `mobile`, `email`, `personal_Id`, `personal_Id_no`, `program_name`, `date`, `time`, `no_of_seats`, `seat_type` FROM `seminarappointment` WHERE id = '".$_SESSION['id']."'";
                                $res = mysqli_query($con,$sql);
                                    if (mysqli_num_rows($res)>0)
                                       {
                            ?>
          ...
          <div class="card" id="card">
            <div class="card-body  table-responsive-sm">
                 <center><h4>YogaCamp Booking</h4></center><br>
                            <?php
                                $sql="SELECT  `name`, `mobile`, `email`, `personal_Id`, `program_name`, `location`, `duration`, `start_date`, `food_choice`, `disease_name` FROM `yogacampappointment` WHERE id = '".$_SESSION['id']."'";
                                    $res = mysqli_query($con,$sql);
                                    if (mysqli_num_rows($res)>0)
                                       {
                            ?>
          ...
          <div class="card" id="card">
            <div class="card-body  table-responsive-sm">
                 <center><h4>BloodDonation Camp Booking</h4></center><br>
                            <?php
                                $sql="SELECT `name`, `mobile`, `email`, `personal_Id`, `personal_Id_no`, `address`,  `blood_grp`,`chronic_disease`, `medication_details` FROM `bloodcampappointment` WHERE id = '".$_SESSION['id']."'";
                                $res = mysqli_query($con,$sql);
                                    if (mysqli_num_rows($res)>0)
                                       {
                            ?>
                                        <table  class="table table-hover table-bordered">
                                          ...
                                          <?php
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row ['medication_details']; ?></td>
                                                <td><a href = 'updateform.php'> <input type = 'button'  class="btn btn-primary btn-sm"  value = 'MODIFY'> </a> </td>
                                                <td><a href = 'deleteform.php'> <input type = 'button'  class="btn btn-primary btn-sm" value = 'CANCEL'> </a> </td>
                                            </tr>
                                            <?php
